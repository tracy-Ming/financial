...
#为price预存points个点
        for i in xrange(1,self.points+1):
            self.price.append(self._get_TestData(i - self.points, self.dt))
            self.sindex.append(i - self.points)
...
#reward except cost
        ...
        sinTensor=self.price[sin_index+1-1:sin_index+points+1-1]
        ...
        return sinTensor.reshape(points+2,1), reward, terminal, {}
