...
parser.add_argument('--training-path', type=str, default='EURUSD60_train_11min.csv')
parser.add_argument('--testing-path', type=str, default='EURUSD60_train_12min.csv')
...
if args.mode == 'train':
    ...
    callbacks = [ModelIntervalCheckpoint(checkpoint_weights_filename, interval=60000)]
